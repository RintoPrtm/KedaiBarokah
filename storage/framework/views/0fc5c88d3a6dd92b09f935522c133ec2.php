<?php $__env->startSection('title', 'Home - ' . $warung->first()->nama_warung); ?>
...
<header id="home"
        ...
        style="
          background: 
            ...
            url('<?php echo e(asset('style/background/background.jpg')); ?>') center/cover no-repeat;
          min-height: 80vh;
          padding: 64px 0;
        ">
    ...
    <div class="row gx-5 justify-content-center align-items-center">
      ...
      <div class="col-12 col-lg-6 mb-4 mb-lg-0">
        <h1 class="display-5 fw-bolder mb-3"
          ...
          <?php echo e($warung->first()->nama_warung); ?>

        </h1>
        <p class="lead mb-4 text-white-75"
            style="text-shadow: 1px 1px 4px rgba(0,0,0,0.5);">
          <?php echo e($warung->first()->alamat_warung); ?>

        </p>
        <a href="<?php echo e(url('warungUser')); ?>" class="btn btn-primary btn-lg px-4">
          Selengkapnya
        </a>
      </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="ratio ratio-16x9 rounded-3 shadow-sm overflow-hidden">
          <img src="<?php echo e(asset('style/image/' . $warung->first()->flayer)); ?>"
...
<section id="kategori" class="py-5">
  <div class="container px-4 my-4">
    ...
    <?php if(isset($menuPromo) && $menuPromo->count()): ?>
      <div class="mb-4">
        <div class="alert alert-warning text-center fw-bold">
          PROMO HARI INI!
        </div>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 justify-content-center">
          <?php $__currentLoopData = $menuPromo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
              <div class="card text-white" style="height: 50vh; overflow: hidden;">
                ...
                ?>
                <img 
                  src="<?php echo e($promo->foto_menu ? asset('style/image/' .$promo->foto_menu) : $flayerPath); ?>" 
                  class="card-img object-fit-cover" 
                  alt="<?php echo e($promo->nama_menu); ?>"
                ...
                <div class="card-img-overlay d-flex flex-column justify-content-end" style="background: rgba(0, 0, 0, 0.3);">
                  ...
                  <p class="fs-5 card-text fw-bold" style="text-shadow: 0 1px 3px rgba(0,0,0,0.6);">
                    <span style="text-decoration: line-through; font-size:0.9em; color: #dc3545;">
                      Rp <?php echo e(number_format($promo->harga, 0, ',', '.')); ?>

                    </span>
                    <br>
                    <span class="ms-2">
                      Rp <?php echo e(number_format($promo->promo, 0, ',', '.')); ?>

                    </span>
                    <span class="badge bg-warning text-dark ms-2">Promo!</span>
                  </p>
                  <a href="<?php echo e(url('/kategoriUser/'.$promo->id_kategori)); ?>" class="btn btn-light mt-2">
                      Lihat Menu
                  </a>
                </div>
              </div>
        ...
        <div class="col">
          <div class="card h-100 text-center border-2 shadow">
            <div class="card-body d-flex flex-column justify-content-between">
              ...
              <a href="<?php echo e(url('/kategoriUser/'.$item->id_kategori)); ?>"
...
<?php echo $__env->make('user.mainUser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\User Rinto\Documents\Project\berkah\resources\views/tampilUser.blade.php ENDPATH**/ ?>