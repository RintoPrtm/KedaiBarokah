...
<head>
    <meta charset="UTF-8">
    <title>Invoice #<?php echo e($pesanan->id_pesanan); ?></title>
    <style>
...
<body>
    <div class="container">
        <h1>INVOICE</h1>
        <h2><?php echo e($warung->nama_warung); ?></h2>
        ...
        <div class="info">
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><?php echo e($pesanan->users->username); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><?php echo e(\Carbon\Carbon::parse($pesanan->jam_pesanan)->format('H:i')); ?></td>
                </tr>
                <tr>
        ...
        <div class="footer">
            ...
            <strong><?php echo e($warung->nama_warung); ?></strong> — <?php echo e($warung->alamat_warung); ?>

        </div>
    </div>
</body>
</html><?php /**PATH D:\User Rinto\Documents\Project\berkah\resources\views/invoice.blade.php ENDPATH**/ ?>