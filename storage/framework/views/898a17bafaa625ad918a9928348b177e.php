  ...
  <div class="container px-4 text-center text-lg-start">
    <div class="row gx-5 justify-content-center align-items-center">
      ...
      <div class="col-12 col-lg-6 mb-4 mb-lg-0">
        ...
        <a href="<?php echo e(url('warung')); ?>" class="btn btn-primary btn-lg px-4">
          Selengkapnya
        </a>
      </div>
            ...
            <div class="col">
              <div class="card text-white" style="height: 50vh; overflow: hidden;">
                ...
                <div class="card-img-overlay d-flex flex-column justify-content-end" style="background: rgba(0, 0, 0, 0.3);">
                  ...
                  <a href="<?php echo e(url('/kategori/'.$promo->id_kategori)); ?>" class="btn btn-light mt-2">
                      Lihat Menu
                  </a>
                </div>
              </div>
        ...
        <div class="col">
          <div class="card h-100 text-center border-2 shadow">
            <div class="card-body d-flex flex-column justify-content-between">
              ...
              <a href="<?php echo e(url('/kategori/'.$item->id_kategori)); ?>"
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\User Rinto\Documents\Project\berkah\resources\views/main.blade.php ENDPATH**/ ?>