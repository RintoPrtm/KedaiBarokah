<?php $__env->startSection('title', 'Profile - ' . $warung->first()->nama_warung); ?>
...
<header id="home"
        ...
        style="
          background: 
            ...
            url('<?php echo e(asset('style/image/' . $warung->first()->foto_warung)); ?>') center/cover no-repeat;
          min-height: 80vh;
          padding: 64px 0;
        ">
    ...
    <div class="row gx-5 justify-content-center align-items-center">
      ...
      <div class="col-12 col-lg-6 mb-4 mb-lg-0">
        ...
        <p class="lead mb-4 text-white-75"
          ...
          "<?php echo e($warung->first()->deskripsi_warung); ?>"
        </p>
        <p class="fw-bold text-shadow-lg">
          Ririn Winarsih <span class="text-primary mx-1">/</span> Pendiri <?php echo e($warung->first()->nama_warung); ?>
...
<?php echo $__env->make('user.mainUser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\User Rinto\Documents\Project\berkah\resources\views/warungUser.blade.php ENDPATH**/ ?>